...
function cargarDatosCliente(idClient) {
    $.ajax({
        dataType: 'JSON',
        url:"http://132.226.246.89:8082/api/Client/"+idClient,
...
function guardarInformacionCliente(){
    let var2 = {
        ...
        url:"http://132.226.246.89:8082/api/Client/save",
...
function actualizarInformacionCliente(idElemento){
    ...
    $.ajax({
        url:"http://132.226.246.89:8082/api/Client/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCliente(idElemento){
    ...
    $.ajax({
        url:"http://132.226.246.89:8082/api/Client/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
