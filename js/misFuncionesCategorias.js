...
function cargarDatosCategoria(id) {
    $.ajax({
        dataType: 'JSON',
        url:"http://132.226.246.89:8082/api/Category/"+id,
...
function guardarInformacionCategorias(){
    ...
    let var2 = {
        ...
        url:"http://132.226.246.89:8082/api/Category/save",
...
function actualizarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://132.226.246.89:8082/api/Category/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCategoria(idElemento){
    ...
    $.ajax({
        url:"http://132.226.246.89:8082/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
